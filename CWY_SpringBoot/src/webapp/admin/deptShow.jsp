...
<head>
    ...
    <script type="text/javascript">
        ...
        function serch() {
            document.info.action = "listDepts";
        ...
        function del() {
            ...
            if (confirm('确认删除吗!?')) {
                document.info.action = "delDepts?ids=" + ids;
                document.info.submit();
            }
...
<form name="info" id="info" action="listDepts" method="post">
    ...
    <table width="95%" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td width="" align="right">
                部门名称：
                <input type="text" id="paramsDept.dept_name" name="deptName"
                       value="${paramsDeptName}" class="inputstyle" Style="width:150px;"/>&nbsp;&nbsp;
    ...
    <table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
        ...
        <c:if test="${depts!=null && depts.size()>0}">

            <c:forEach items="${depts}" var="dept" varStatus="status">

                <tr class="<c:if test='${status.index % 2!=0}'>
                                list1
                           </c:if>
                    ...
                    <td width="" align="center">
                        <input type="checkbox" name="chkid" value="${dept.id}" cssStyle="vertical-align:text-bottom;">
                    </td>
                    <td width="" align="center">
                    ...
                    <td width="" align="center">
                        ...
                        <a href="editDept?id=${dept.id}">编辑</a>
                    </td>
                </tr>
            </c:forEach>
        </c:if>

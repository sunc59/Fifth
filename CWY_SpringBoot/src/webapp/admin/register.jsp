...
<form id="info" name="info" action="register" method="post">
                ...
                <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
                    <tr>
                        ...
                        <td width="65%" class="field">
                            <input type="text" name="userName" id="params.user_name" style="width:200px;"/>
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <input type="password" name="userPass" id="params.user_pass" style="width:200px;"/>
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <input type="password" name="userRpass" id="user_rpass" style="width:200px;"/>
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <input type="text" name="realName" id="params.real_name" style="width:200px;"/>
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <input type="radio" id="sex1" name="userSex" checked="checked" value="1"/>男&nbsp;&nbsp;
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <input type="text" id="params.random" name="random" style="width:80px;"
                                   class="inputstyle"/>
                            &nbsp;<img src="Random.jsp" width="60" height="22" style="cursor:pointer;padding-top:5px"
                                       title="换一张" id="safecode" border="0" onClick="reloadcode()"/>

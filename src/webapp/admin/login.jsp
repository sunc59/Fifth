...
<BODY>
<FORM id="info" name="info" method="post" action="login">
                                ...
                                <TD>
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <TR>
                                            ...
                                            <TD style="HEIGHT: 28px" width=150><INPUT id="params.user_name"
                                                                                      name="userName"
                                                                                      value="${params.userName}"
                                                                                      style="WIDTH: 130px" name=txtName>
                                            </TD>
                                        ...
                                        <TR>
                                            ...
                                            <TD style="HEIGHT: 28px"><INPUT id="params.user_pass" name="userPass"
                                                                            style="WIDTH: 130px"
                                                                            type="password"></TD>
                                        ...
                                        <TR>
                                            ...
                                            <TD style="HEIGHT: 28px">
                                                <INPUT id="params.random" name="random" style="WIDTH: 60px"
                                                       name=txtcode>
                                                <img src="Random.jsp" width="50" valign="middle"
                                                     style="cursor:pointer;vertical-align:middle" title="换一张"
                                                     id="safecode" border="0" onClick="reloadcode()"/>
                                            </TD>
                                            <TD style="HEIGHT: 28px">
                                                <SPAN id="RequiredFieldValidator3"
                                                      style="FONT-WEIGHT: bold; VISIBILITY: hidden; COLOR: white">请输入验证码</SPAN>
                                            </TD>
                                        </TR>
                                        <TR>
                                            <TD></TD>
                                            <TD colspan="2" id="loginTip"
                                                style="HEIGHT:22px;color:orange">${errTip}</TD>
                                        </TR>
                                        <TR>
                                            <TD></TD>
                                            <TD>
                                                <img id="loginInBtn" style="border:0px;cursor:pointer"
                                                     src="images/login_button.gif"/>
                                                &nbsp;&nbsp;

                                                <img id="regInBtn"  style="border:0px;cursor:pointer"
                                                     src="images/reg_button.gif" />

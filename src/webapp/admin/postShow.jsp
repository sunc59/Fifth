...
<head>
    ...
    <script type="text/javascript">
        ...
        function serch() {
            document.info.action = "listPosts";
        ...
        function del() {
            ...
            if (confirm('确认删除吗!?')) {
                document.info.action = "delPosts?ids=" + ids;
                document.info.submit();
            }
...
<body>
    ...
    <form name="info" id="info" action="listPosts" method="post">
                ...
                <td width="" align="right">
                    ...
                    <c:if test="${admin.userType == 2}">
                        ...
                        <input type="text" id="realName" name="realName"
                               value="${paramsPost.realName}" class="inputstyle" style="width:100px"/>&nbsp;&nbsp;
                        部门：
                        <select id="paramsPost.dept_id" name="deptId" class="selectstyle" style="width: 100px">
                    ...
                    审核状态：
                    <select name="postFlag" class="selectstyle" style="width: 100px">
                        <option value="0">请选择</option>
                ...
                <c:forEach items="${posts}" var="post" varStatus="status">
                    ...
                    <tr class="
                        ...
                        <td width="" align="center">
                            <input type="checkbox" value="${post.id}" name="chkid" cssStyle="vertical-align:text-bottom;">
                        </td>
                        ...
                        <td width="" align="center">
                            ${post.postDate1Desc}&nbsp;${post.postLesson1Desc}
                        </td>

                        <td width="" align="center">
                            ${post.postDate2Desc}&nbsp;${post.postLesson2Desc}
                        </td>
                        ...
                        <td width="" align="center">&nbsp;
                            <c:if test="${post.postFlag == 1 && admin.userType == 1}">
                                <a href="editPost?id=${post.id}">编辑</a>
                            </c:if>

                            <c:if test="${post.postFlag == 1 && admin.userType == 2}">
                                <a href="assessPost?id=${post.id}&postFlag=2">审核通过</a>
                                <br/>&nbsp;
                                <a href="assessPost?id=${post.id}&postFlag=3">审核驳回</a>
                            </c:if>
                        </td>

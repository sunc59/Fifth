...
<div class="top">
    <div class="top1">
        ...
        <div class="top_info"><img src="images/zxtb.gif" style="border:0px;vertical-align:middle"/>&nbsp;&nbsp;<a
                id="logOut" href="#">退出系统</a></div>
    </div>
    <div class="top2">
        <div class="shijian" id="timeDiv"></div>
        <div class="user">${admin.userTypeDesc} &nbsp;&nbsp;${admin.realName}&nbsp;&nbsp;欢迎您进入员工考勤信息管理平台！</div>
    </div>
</div>
</body>
</html>
